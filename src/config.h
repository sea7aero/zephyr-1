...
constexpr uint64_t THING_NETWORK_DEV_EUI = 0x70B3D57ED006ED02;
#endif
...
constexpr uint64_t joinEUI = THING_NETWORK_JOIN_EUI;
constexpr uint64_t devEUI = THING_NETWORK_DEV_EUI;
constexpr uint8_t appKey[16] = {
    0x73, 0xA3, 0x1E, 0xB6, 0xBD, 0x9C, 0x20, 0x28,
    0xFE, 0x99, 0xCF, 0x0F, 0xBA, 0xA4, 0x9B, 0xCB};
constexpr uint8_t nwkKey[16] = {
    0xC5, 0x83, 0xDA, 0x50, 0x3A, 0xE3, 0xE0, 0x4B,
    0x52, 0x48, 0x17, 0xE1, 0xBE, 0x78, 0x8C, 0xAC};
